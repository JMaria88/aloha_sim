...
"""Creates aloha sim task environments using dm_control.composer."""

import inspect
from aloha_sim.tasks import blocks_spelling
from aloha_sim.tasks import bowl_on_rack
from aloha_sim.tasks import desktop_wrap_headphone
